...
public class Source implements Parcelable {
	...
	@SerializedName("urlsToLogos") @Expose private UrlsToLogos urlsToLogos;
	@SerializedName("sortBysAvailable") @Expose private List<SortType> sortBysAvailable = null;
	...
	public static final Parcelable.Creator<Source> CREATOR = new Parcelable.Creator<Source>() {
		@Override
		public Source createFromParcel(Parcel source) {return new Source(source);}
		
		@Override
		public Source[] newArray(int size) {return new Source[size];}
	};
	...
	public static class UrlsToLogos implements Parcelable {
		...
		public static final Creator<UrlsToLogos> CREATOR = new Creator<UrlsToLogos>() {
			@Override
			public UrlsToLogos createFromParcel(Parcel source) {return new UrlsToLogos(source);}
			
			@Override
			public UrlsToLogos[] newArray(int size) {return new UrlsToLogos[size];}
		};
	}
